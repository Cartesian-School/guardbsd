...
//! Package: kernel_syscall
//! Copyright © 2025 Cartesian School. Developed by Siergej Sobolewski.
//! License: BSD-3-Clause
//!
//! Pełna implementacja interfejsu syscalls.
...
pub fn syscall_handler(syscall_num: usize, arg1: usize, arg2: usize, arg3: usize) -> isize {
    match syscall_num {
        ...
        SYS_KILL => process_jobctl::sys_kill(arg1 as isize, arg2 as i32),
        SYS_WAITPID => process_jobctl::sys_waitpid(arg1 as isize, arg2 as *mut i32, arg3 as u32),
        SYS_SETPGID => process_jobctl::sys_setpgid(arg1, arg2),
        SYS_GETPGID => process_jobctl::sys_getpgid(arg1),
        ...
        SYS_WRITE => fs::sys_write(arg1 as u32, arg2 as *const u8, arg3),
        SYS_READ => fs::sys_read(arg1 as u32, arg2 as *mut u8, arg3),
        SYS_OPEN => fs::sys_open(arg1 as *const u8, arg2 as u32),
        SYS_CLOSE => fs::sys_close(arg1 as u32),
        SYS_DUP => fs::sys_dup(arg1),
        SYS_DUP2 => fs::sys_dup2(arg1, arg2),
        SYS_STAT => fs::sys_stat(arg1 as *const u8, arg2 as *mut u8),
        ...
        SYS_TCSETPGRP => fs::sys_tcsetpgrp(arg1 as u32, arg2),
        SYS_TCGETPGRP => fs::sys_tcgetpgrp(arg1 as u32),
        _ => -1,
    }
}
