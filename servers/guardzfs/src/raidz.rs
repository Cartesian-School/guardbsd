...
//!
//! Implementacja RAID-Z w GuardZFS.
...
pub fn raidz_write(
    ...
    match vdev.vdev_type {
        ...
        VdevType::RaidZ2 => {
            ...
            let (p_parity, q_parity) =
                raidz2_calculate_parity(&chunk_ptrs[..vdev.stripe_width as usize]);
            ...
            write_fn(
                vdev.children[vdev.stripe_width as usize + 1],
                offset,
                &q_parity,
            )
    ...
    match vdev.vdev_type {
        ...
        VdevType::RaidZ1 | VdevType::RaidZ2 => {
            ...
            if let Some(failed_idx) = failed_disk {
                ...
                chunks[failed_idx] =
                    raidz1_reconstruct(&block_refs[..=vdev.stripe_width as usize], failed_idx);
