...
2. Send a **detailed report** to:  
   Email: [security@guardbsd.org](mailto:security@guardbsd.org)  
   PGP Key: [https://guardbsd.org/pgp-key.txt](https://guardbsd.org/pgp-key.txt)
...
[https://guardbsd.org/security/advisories](https://guardbsd.org/security/advisories)
